...
collection_name = "RAG_Central_Acts_LawSage_Collection"
...
if collection_flag:
    ...
    dataset = open('dataset/Central Acts Legislation of India/RAG-Central Acts Legislation of India.txt', encoding='utf-8').read()
    chunks = get_overlapped_chunks(dataset, 10000, 1000)
...
def RAG_central_acts_get_context(query):
