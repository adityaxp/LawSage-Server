...
collection_name = "RAG_Constitution_LawSage_Collection"
...
if collection_flag:
    ...
    dataset = open('dataset/Constitution/RAG-Constitution.txt', encoding="latin-1").read()
...
def RAG_constitution_get_context(query):
